...
- `README.md`, `docs/specdrive/README.md`, `docs/specdrive/README.ko.md`, `docs/specdrive/doc-reinforce-flow.md`, `docs/specdrive/doc-stage-testing.md` 를 새 `doc` 루프 의도에 맞게 정리
...
- `docs/specdrive/doc-stage-testing.md` 는 현재 key 기반 registry routing 과 preview 테스트 기준에 맞게 정리된 상태다.
...
### 우선순위 3
- GitHub CLI `gh` 설치 후 `$github-pr` skill 을 다시 실행해 기존 PR 확인, base branch 결정, PR 제목/본문 초안, PR 생성 흐름 검증
...
- 현재 기준 문서와 실행 자산 경로를 `docs/specdrive/**`, `.agents/skills/**`, `specdrive/codex-skills/**` 중심으로 정리
...
- `docs/specdrive/runtime-structure.md`, `doc-stage-testing.md` 최신 상태 반영
