...
powershell -ExecutionPolicy Bypass -File specdrive/scripts/util/context-bundle.ps1 -Documents docs/projects/board/01-overview.md,docs/specdrive/session-stage.md -Name board-session-context
...
현재 세부 검토 메모는 `docs/specdrive/todo/doc-map-todo.md` 에 둔다.
...
- specdrive 문서: `docs/specdrive/**`, `docs/specdrive/AGENTS.md`
...
현재 세부 검토 메모는 `docs/specdrive/todo/affected-docs-map-todo.md` 에 둔다.
